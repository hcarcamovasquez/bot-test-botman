...
class QuotationConversation extends Conversation
{
    ...
    {
        $question = Question::create('Indicar Marca del televisor EJ: "LG","SAMSUNG","SONY"')
    ...
    public function askSphone()
    {
        ...
        $question = Question::create('Indicar Marca del smartphone  EJ: "APPLE","SAMSUNG","HUAWEI"\'')
            ->callbackId('ask_quotation');

        return $this->ask($question, function (Answer $answer) {

            $infoSphone = array('APPLE', 'SAMSUNG', 'HUAWEI');
            foreach ($infoSphone as list($list)) {
                ...
                if (strtoupper($answer->getText()) === $list) {
                    ...
                    $this->say('Seleccionar alguno de stas Marcas Apple, Samsung o Huawei');
                    break;
                }
            }
    ...
    public function askEmail()
    {
        $this->ask('Favor de ingresar correo?', function (Answer $answer) {
            ...
            $this->say('Muchas gracias, ' . $this->firstname . ' su cotización será enviada al correo ' . $this->email);
        });
    }
